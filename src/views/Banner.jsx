...
import { BannerPic } from "../AxiosData/AxiosData";
 ...
 function Banner(){
  ...
  useEffect(() => {
    ...
    .catch((err) => {console.log("ERROR:轮播图数据请求失败...");})
  },[])

//图片轮播 bannerId pic

const items = list.map((vul, index) => (
 ...
 return  <div className="w-[90vw] h-[36vw] rounded-2xl flex   items-center overflow-hidden m-[auto]">
