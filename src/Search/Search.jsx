...
import { Input, TabBar, Swiper } from 'antd-mobile';
import {
  LeftOutline,
  TeamFill,
  ShopbagOutline,
...
export default function Search() {
  const items = ListNew();
  return (
    <div className="bg-[#F4F4F4] h-[100%] w-[100%] pb-[12vw]">
      <div className="w-[91vw] h-[20vw] mx-auto flex justify-between items-center">
        <NavLink to="/App">
          <span>
            <TabBar>
              <TabBar.Item icon={<LeftOutline style={{ color: 'black' }} />} />
            </TabBar>
          </span>
        </NavLink>
      ...
      <div className="px-3 py-4">
        <h1 className="flex justify-between items-center  font-semibold text-[4vw] text-[#283349] ">
          <span>猜你喜欢</span>
          <span />
        </h1>
      </div>
